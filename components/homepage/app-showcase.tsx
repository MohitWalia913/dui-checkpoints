          ...
          <div className="relative  lg:max-w-[100%] w-full  md:max-w-[50%] lg:max-w-[785px]">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="relative min-w-0 flex-1 overflow-hidden">
                <div
                  className="height-app flex transition-transform duration-500 ease-out"
                  style={{
                  ...
                  {PHONE_SLIDES.map(({ src, alt }, i) => (
                    ...
                    >
                      <Image
                        ...
                        width={220}
                        height={440}
                        className={`h-auto w-full max-w-full object-cover lg:object-contain lg:max-h-[400px] lg:w-full lg:max-w-[180px] ${
                          i >= activeIndex &&
