  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1338px] px-6 md:px-10 lg:px-14">
        <div className="flex flex-col items-start  gap-12 w-full md:items-center lg:flex-row lg:grid-cols-2 lg:gap-10 xl:gap-14">
          {/* Left — report form */}
          ...
          <div className="protect-right relative w-full  max-w-full lg:max-w-[697px] rounded-2xl lg:mt-[0px] bg-white shadow-[0_0_14px_rgba(0,0,0,0.25)] rounded-[20px] p-[25px] md:p-[30px] lg:p-[35px] xl:p-[40px]">
