...
export function Coverage() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1338px] px-0 md:px-0 lg:px-14">
        <div className="grid lg:grid-cols-2">
          {/* Left — copy & CTAs */}
          <div className="relative z-10 flex flex-col justify-center !pl-[0px] px-6 py-10 md:px-10 md:py-10 lg:px-14 lg:py-24">
            <div className="calfornia-left-cil-inner-box w-full  px-6  md:px-10 lg:px-0 "> 
          ...
          {/* Right — California map (removed, now background) */}
          <div className="relative min-h-[320px] lg:min-h-[520px] block lg:hidden">
          <div
