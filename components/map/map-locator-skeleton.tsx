export function MapLocatorSkeleton({ mapOnly = false }: { mapOnly?: boolean }) {
  return (
    <div
      className={
        mapOnly
          ? "flex h-full min-h-[480px] flex-col"
          : "flex h-full min-h-[480px] flex-col lg:flex-row"
      }
    >
      {!mapOnly ? (
      ...
      <div
        className={
          mapOnly
            ? "relative min-h-[480px] flex-1 animate-pulse bg-[#0a1628]"
            : "relative min-h-[50vh] flex-1 animate-pulse bg-[#0a1628] lg:min-h-0"
        }
      >
